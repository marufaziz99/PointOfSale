...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 21, 2019 at 03:39 AM
...
(62, 'Susu Putih', 10, 0, 10, 8.5, 'Liter', 1),
(63, 'Susu Coklat', 10, 0, 10, 9.7, 'Liter', 1),
(64, 'Cup', 100, 0, 100, 79, 'Cup', 1),
(65, 'Yakult', 50, 0, 50, 46, 'Botol', 1),
(66, 'Bubble', 60, 0, 60, 60, 'Bungkus', 1),
(67, 'Lychee', 20, 0, 20, 19.6, 'Liter', 1),
...
(13, 'Choco Bar', 23, 7, 30, 26, 1),
(14, 'Thai Tea', 19, 6, 25, 23, 1),
(15, 'Taro', 25, 0, 25, 21, 1),
...
--
ALTER TABLE `jual`
  MODIFY `no_nota` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
...
--
ALTER TABLE `powder`
  MODIFY `id_powder` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=76;
