            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                <div class="x_title">
                  <h2><i class="fa fa-bars"></i> Transaksi <small>Shift 2</small></h2>
									              	...
									              	<?php
									              		$currentDate = date('Y/m/d');
																		$hasil = $query->query("SELECT dt.no_nota, s.Nama, j.tanggal, j.waktu, j.nama_pembeli, p.nama_powder, sj.nama_penyajian, t.nama_topping, dt.jumlah, j.status 
																					   ...
																					   WHERE (j.tanggal = '$currentDate') AND (j.waktu BETWEEN '16:00:00' AND '22:00:00') AND dt.id_region = " . $value->id_region);
