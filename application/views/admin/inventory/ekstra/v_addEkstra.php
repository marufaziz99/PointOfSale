      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2>Input Data <small>Ekstra</small></h2>
          ...
          <div class="x_content"> 
            ...
            <br />
            <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left input-mask" method="post" action="<?=base_url('index.php/c_admin/insert_ekstra')?>">
            	<div class="row">
	                ...
	                <input type="text" class="form-control" id="inputSuccess3" placeholder="ex : Bubble" name="nama" required="">
	              </div>
            	</div>
            	...
            	<div class="row">
	                ...
	                <input type="number" class="form-control" id="inputSuccess2" placeholder="ex: 50000" name="stok" required="">
	              </div>
